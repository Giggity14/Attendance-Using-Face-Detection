...
class Student:
    def __init__(self, root):
        ...
        #-studentID
        studentID_label=Label(Student_info_frame,text="ID",font=("arial",10),bg="aliceblue",fg="black")
        ...
        update_photo_btn=Button(btn_frame2,command=self.generate_dataset,text="Update Photo",width=20,font=("arial",10,"bold"),bg="lightblue",fg="black")
